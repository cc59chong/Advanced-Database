...
select * from exams;
/*1* basic cursor --- fetch-------------------------------------------1*/
create or replace function something2() returns integer as $$
declare
     examsCur2 cursor for select * from exams;
     erow exams%rowtype;
begin
    open examsCur2;
    fetch examsCur2 into erow;
    while found loop 
...
/*4* update/delete cursor --- for loop-------------------------------------------*/
create or replace function something() returns integer as $$
declare
     examsCur cursor for select * from exams;
begin
